...
config_export -format ip_catalog -output D:/HLS/HLSFinal_2021Spring/ACA-HLS-Final-Team2-Tomasulo-RISC-V/CPU-IP/cpu.zip -rtl verilog
source "./final-project-hls/solution1/directives.tcl"
csim_design
csynth_design
cosim_design -trace_level all
export_design -rtl verilog -format ip_catalog -output D:/HLS/HLSFinal_2021Spring/ACA-HLS-Final-Team2-Tomasulo-RISC-V/CPU-IP/cpu.zip
